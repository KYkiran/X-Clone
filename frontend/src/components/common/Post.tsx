...
import { formatPostDate } from "../../utils/date/index.ts";
				...
				<div className='flex justify-between mt-3'>
					<div className='flex gap-4 items-center w-2/3 justify-between'>
						<div
							...
							onClick={() =>
								(document.getElementById("comments_modal" + post._id) as HTMLDialogElement)?.showModal()
							}
						>
						...
						<dialog id={`comments_modal${post._id}`} className='modal'>
							<div className='modal-box rounded border border-gray-600'>
								...
								<form onSubmit={handlePostComment} className='flex gap-2 items-center mt-4 border-t pt-2'>
									<textarea
